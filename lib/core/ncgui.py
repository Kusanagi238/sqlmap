...
try:
    ...
    # Some Python builds (e.g. PyPy on Windows) do not provide the
    # native _curses extension. Avoid failing import time so the
    # package can handle the missing dependency later in a controlled
    # manner.
    curses = None
